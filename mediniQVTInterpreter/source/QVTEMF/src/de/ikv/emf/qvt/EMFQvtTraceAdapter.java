...
public class EMFQvtTraceAdapter implements QvtTraceAdapter {
	...
	public void storeTraces(Collection traces) {
		if (this.getWorkingLocation() == null) {
			return;
		}
		Date x = new Date();
	...
	protected void saveTraceResources(Map traceResourceMap, ResourceSet resourceSet) {
		...
		for (Iterator iter = transformationNames.iterator(); iter.hasNext();) {
			...
			URI traceMMFileUri = this.getWorkingLocation().appendSegment(currentTransformationName)
	...
	protected URI getTraceFile(String currentTransformationName) {
		return this.getWorkingLocation().appendSegment(EMFQvtTraceAdapter.TRACE_FILE_NAME).appendFileExtension(
	...
	protected void buildTraceMMForTransformation(ResourceSet resourceSet, Transformation currentTransformation) {
		String currentTransformationName = currentTransformation.getName();
		URI traceMMFileUri = this.getWorkingLocation().appendSegment(currentTransformationName).appendFileExtension(
		    "ecore");
