...
public class QvtVariableAccessFinderVisitorImpl extends
		QvtExpressionFinderVisitorImpl {
	...
	public QvtVariableAccessFinderVisitorImpl(boolean isWhen,
	...
	public Object visit(RelationCallExp host, Object data) {
		...
		for (Iterator iter = arguments.iterator(); iter.hasNext();) {
			...
			/*
			 * Delegate resolving the expression if the expression is not a
			 * variable.
			 */
			...
			/*
			 * A variable argument being mapped on a source domain or primitive
			 * domain need to be resolved.
			 */
			if (!(this.direction != null && this.direction
					.equals(relationDomain.getTypedModel()))) {
				currentArgument.accept(this, data);
			}
		}
		return null;
